...
class Multiple_Creat(models.Model):
    zhoushu = models.CharField(max_length=32)
    startweek = models.CharField(max_length=32)
    endweek = models.CharField(max_length=32)
    week = models.CharField(max_length=32)
    startclass = models.CharField(max_length=32)
    endclass = models.CharField(max_length=32)
    Class = models.CharField(max_length=32)
    ClassAdress = models.CharField(max_length=32)
